...
#if defined TIME_BIASED_LIST
#include <havoqgt/random_edge_container/time_biased_list_random_edge_container.hpp>
#elif defined TIME_BIASED_INTERVAL_TREE
#include <havoqgt/random_edge_container/time_biased_interval_tree_rec.hpp>
#elif defined INTERVAL_TREE
